      ...
      <nav className="relative z-20 py-4 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button className="cyber-button-primary modern-font" onClick={handleStartJourney}>
          ...
          <div className="slide-in-right space-y-6">
            ...
            <div className="cyber-card cyber-card-right p-8">
              <div className="space-y-4">
                ...
                {/* CTA Button */}
                <Button 
                  className="cyber-button-primary modern-font w-full text-lg py-6 font-semibold mt-6"
